...
### Teacher calendar blocks: found at preview, archived at apply — now calendar-hook-driven (bottom-up sync redesign, Phase 7, 2026-09-08)
...
[`attendance_template.md`](../attendance/attendance_template.md)'s "Bottom-up sync redesign"
...
Session archival is the one piece this method still does explicitly and unconditionally, right
before it returns:
