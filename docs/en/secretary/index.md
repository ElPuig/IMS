[Català](../../ca/secretary/index.md) | [Castellano](../../es/secretary/index.md) | [English](index.md)

---

# Secretariat — User Manuals

This section contains the manuals for **secretariat staff**.

---

## Available Manuals

- [Academic history: per-course student records](academic-history.md) — What the permanent academic history contains, when it is generated (withdrawals and course transition) and how to consult or adjust it.
- [Work placement (EM) grade](../tutors/work-placement-grade.md) — Enter or correct the placement grade of any student and close the finals still pending from previous courses (shared manual with the tutors).
