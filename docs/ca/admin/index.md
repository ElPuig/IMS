[Català](index.md) | [Castellano](../../es/admin/index.md) | [English](../../en/admin/index.md)

---

# Administrador — Manuals d'usuari

Aquesta secció conté els manuals per a **administradors**.

---

## Manuals disponibles

- [Nivells](curriculum-levels.md) — Configuració curricular: nivells educatius.
