...
# teachers at once in one transaction (the working-schedules import wizard, course_transition_
# wizard, the offline regenerate_all_from_calendars) - sync_from_schedule_batch's cross-template
...
# calendar-writing phase, then runs its own explicit batch sync afterward exactly as before.
