...
class ims_teaching(models.Model):
	...
	teacher = fields.Many2one(string="Teacher", comodel_name="hr.employee", required="true", domain="[('employee_type', '=', 'teacher')]")	
	group = fields.Many2one(string="Group", comodel_name="ims.group", required="true")	
